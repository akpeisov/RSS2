...
@Repository
public interface DeviceConfigRepository extends JpaRepository<DeviceConfiguration, UUID> {
    Optional<DeviceConfiguration> findByController(Controller controller);
}
